...
H2_JAX_TRIPLET_HARTREE_ENERGY_BASELINE = H2JaxTripletHartreeEnergyRegressionBaseline(
    ...
    jax_hartree_cgloop_route=H2JaxTripletHartreeEnergyRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-1.218429058471,
        final_lowest_eigenvalue_ha=-0.33123672812,
        hartree_solve_call_count=41,
        total_wall_time_seconds=135.602605,
        average_iteration_wall_time_seconds=6.78013025,
        average_hartree_solve_wall_time_seconds=0.4075170731707317,
        first_hartree_solve_wall_time_seconds=5.333281,
        repeated_hartree_solve_average_wall_time_seconds=0.284372975,
        repeated_hartree_solve_min_wall_time_seconds=0.128627,
        repeated_hartree_solve_max_wall_time_seconds=0.506663,
        average_hartree_cg_iterations=400.0,
        first_hartree_cg_iterations=400,
        repeated_hartree_cg_iteration_average=400.0,
        average_hartree_boundary_condition_wall_time_seconds=0.012307,
        average_hartree_build_wall_time_seconds=0.057364,
        average_hartree_rhs_assembly_wall_time_seconds=0.027542,
        average_hartree_cg_wall_time_seconds=0.277892,
        average_hartree_cg_other_overhead_wall_time_seconds=0.02529,
        average_hartree_matvec_call_count=401.0,
        average_hartree_matvec_wall_time_seconds=0.5172322461402495,
        average_hartree_matvec_wall_time_per_call_seconds=0.0012898559754120935,
        ...
        average_hartree_cg_iteration_wall_time_seconds=0.0006947309692645276,
        average_hartree_matvec_wall_time_per_iteration_seconds=0.0012930806153506238,
        ...
        first_hartree_matvec_wall_time_seconds=0.5082370235177223,
        repeated_hartree_matvec_average_wall_time_seconds=0.5174571267058127,
        first_hartree_matvec_wall_time_per_call_seconds=0.0012674239987973124,
        repeated_hartree_matvec_wall_time_per_call_seconds=0.001290416774827463,
        hartree_cached_operator_usage_count=41,
        hartree_cached_operator_first_solve_count=1,
        eigensolver_wall_time_seconds=107.044239,
        static_local_prepare_wall_time_seconds=27.280187,
        hartree_solve_wall_time_seconds=16.7316,
        local_ionic_resolve_wall_time_seconds=0.0,
        xc_resolve_wall_time_seconds=0.0,
        energy_evaluation_wall_time_seconds=14.165273,
    ...
    jax_hartree_pcg_stronger_route=H2JaxTripletHartreeEnergyRouteBaseline(
        ...
        converged=True,
        iteration_count=18,
        final_total_energy_ha=-1.221449868246,
        final_lowest_eigenvalue_ha=-0.41705510557,
        hartree_solve_call_count=37,
        total_wall_time_seconds=146.14802,
        average_iteration_wall_time_seconds=8.119334444444445,
        average_hartree_solve_wall_time_seconds=0.5826205405405406,
        first_hartree_solve_wall_time_seconds=3.62599,
        repeated_hartree_solve_average_wall_time_seconds=0.49808305555555557,
        repeated_hartree_solve_min_wall_time_seconds=0.359257,
        repeated_hartree_solve_max_wall_time_seconds=0.739665,
        average_hartree_cg_iterations=270.02702702702703,
        first_hartree_cg_iterations=283,
        repeated_hartree_cg_iteration_average=269.6666666666667,
        average_hartree_boundary_condition_wall_time_seconds=0.013003,
        average_hartree_build_wall_time_seconds=0.001126,
        average_hartree_rhs_assembly_wall_time_seconds=0.023312,
        average_hartree_cg_wall_time_seconds=0.497006,
        average_hartree_cg_other_overhead_wall_time_seconds=0.144033,
        average_hartree_matvec_call_count=271.02702702702703,
        average_hartree_matvec_wall_time_seconds=0.36206479789649854,
        average_hartree_matvec_wall_time_per_call_seconds=0.0013358992343608343,
        average_hartree_preconditioner_apply_count=270.05405405405406,
        average_hartree_preconditioner_apply_wall_time_seconds=0.37287975880816876,
        average_hartree_preconditioner_apply_wall_time_per_call_seconds=0.0013807597153625143,
        average_hartree_preconditioner_setup_wall_time_seconds=0.0007133687298895942,
        average_hartree_preconditioner_axis_reorder_wall_time_seconds=0.17618977032425637,
        average_hartree_preconditioner_tridiagonal_solve_wall_time_seconds=0.3621806842914068,
        average_hartree_preconditioner_other_overhead_wall_time_seconds=0.0,
        average_hartree_cg_iteration_wall_time_seconds=0.001840578437692119,
        average_hartree_matvec_wall_time_per_iteration_seconds=0.0013408465140797164,
        average_hartree_other_cg_overhead_wall_time_per_iteration_seconds=0.0004997319236124025,
        first_hartree_matvec_call_count=284,
        repeated_hartree_matvec_call_count_average=270.6666666666667,
        first_hartree_matvec_wall_time_seconds=0.34413387591484934,
        repeated_hartree_matvec_average_wall_time_seconds=0.36256287906265544,
        first_hartree_matvec_wall_time_per_call_seconds=0.0012117389997001737,
        repeated_hartree_matvec_wall_time_per_call_seconds=0.0013395180260935544,
        hartree_cached_operator_usage_count=37,
        hartree_cached_operator_first_solve_count=1,
        eigensolver_wall_time_seconds=113.721522,
        static_local_prepare_wall_time_seconds=31.196407,
        hartree_solve_wall_time_seconds=21.580338,
        local_ionic_resolve_wall_time_seconds=0.0,
        xc_resolve_wall_time_seconds=0.0,
        energy_evaluation_wall_time_seconds=16.067554,
        kinetic_energy_wall_time_seconds=0.0,
        local_ionic_energy_wall_time_seconds=0.0,
        hartree_energy_wall_time_seconds=0.0,
        xc_energy_wall_time_seconds=0.0,
    ...
    diagnosis=(
        "This baseline freezes the line-preconditioner apply-cost audit on the cached triplet JAX "
        "Hartree route. The stronger metric-aware line preconditioner still lowers the average "
        "Hartree iteration count materially, from about 400.0 to about 270.0, but the route remains "
        "slower end-to-end because preconditioner apply itself is expensive. The new profiling split "
        "shows that the main line-preconditioner cost is not setup but repeated apply work, dominated "
        "by the tridiagonal solve plus axis reordering. That means the stronger-PCG direction still "
        "has engineering value, but only if the apply path itself is made much cheaper."
    ),
    note=(
        "Very rough triplet-only SCF profiling baseline for the line-preconditioner apply-cost audit "
        ...
        "path; they differ only in `cg_preconditioner`. Timing values are rough wall-time references, "
