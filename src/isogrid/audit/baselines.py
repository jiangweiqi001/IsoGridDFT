...
H2_JAX_SINGLET_MAINLINE_BASELINE = H2JaxSingletMainlineRegressionBaseline(
    ...
    baseline_linear_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-0.28000868897138464,
        final_lowest_eigenvalue_ha=-0.2175359281623796,
        final_density_residual=0.27081204610849086,
        final_energy_change_ha=-0.10663861438493838,
        total_wall_time_seconds=99.006373299,
        average_iteration_wall_time_seconds=4.95031866495,
        ...
        tail_energy_change_history_ha=(
            -0.011515294750656093,
            -0.01222347334992398,
            -0.012875723894127044,
            0.03623381478486511,
            -0.10663861438493838,
        ),
        ...
        average_tail_residual_ratio=0.9705153454750212,
        tail_residual_ratio_std=0.053441612840143295,
    ...
    diis_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=0.318762582673937,
        final_lowest_eigenvalue_ha=-1.1469706027572923,
        final_density_residual=0.6730479130751487,
        final_energy_change_ha=0.46088250230687877,
        total_wall_time_seconds=101.51155915500001,
        average_iteration_wall_time_seconds=5.075577957750001,
        ...
        average_tail_residual_ratio=1.26849035215715,
        tail_residual_ratio_std=0.494330228241503,
        entered_plateau=False,
    ...
    anderson_baseline_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-0.16416945130600624,
        final_lowest_eigenvalue_ha=-0.41255909601004426,
        final_density_residual=0.3074448313220238,
        final_energy_change_ha=0.011491461129379932,
        total_wall_time_seconds=111.82896126099996,
        average_iteration_wall_time_seconds=5.591448063049998,
        ...
        tail_energy_change_history_ha=(
            -0.02028407963860649,
            0.01436117140582938,
            -0.019259703997849503,
            0.01327320112100731,
            0.011491461129379932,
        ),
        tail_residual_ratios=(
            0.9762866872980445,
            1.022603138524824,
        ...
        average_tail_residual_ratio=1.0001735821972653,
        tail_residual_ratio_std=0.02704838463403502,
        ...
        anderson_rejected_iterations=(),
        anderson_reset_iterations=(),
        anderson_filtered_history_sizes=(1, 2, 3, 3, 4, 4, 4, 4, 3, 2, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2),
        anderson_effective_damping_history=(0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5),
        anderson_projected_residual_ratio_history=(0.5092003622558553, 0.5050113008131202, 0.5000002946483426, 0.5000838740470838, 0.5000833790164448, 0.5022522624098011, 0.5030320569185185, 0.5020910571287358, 0.5004893552468633, 0.5001707920997335, 0.5001867832269009, 0.5005903983651685, 0.5002766075717477, 0.5001565502875849, 0.5003006534272698, 0.5001120527967022, 0.5000647984807841, 0.5001490978720438),
        eigensolver_wall_time_seconds=None,
        static_local_prepare_wall_time_seconds=None,
        hartree_solve_wall_time_seconds=None,
        energy_evaluation_wall_time_seconds=None,
    ...
    anderson_productionish_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-0.1759008937132982,
        final_lowest_eigenvalue_ha=-0.3771211202008719,
        final_density_residual=0.3006091022338575,
        final_energy_change_ha=0.01315817603692937,
        total_wall_time_seconds=122.06796740100003,
        average_iteration_wall_time_seconds=6.103398370050002,
        behavior_verdict="plateau_or_stall",
        detected_two_cycle=False,
        even_odd_energy_gap_ha=None,
        even_odd_residual_gap=None,
        ...
        tail_energy_change_history_ha=(
            -0.014525231802459601,
            0.013317417395412336,
            -0.012118895415501914,
            0.017455876590428503,
            0.01315817603692937,
        ),
        tail_residual_ratios=(
            0.9924061179918305,
        ...
        average_tail_residual_ratio=1.0003952690444395,
        tail_residual_ratio_std=0.00770161955411814,
        entered_plateau=True,
        diis_used_iterations=(),
        diis_fallback_iterations=(),
        ...
        anderson_effective_damping_history=(0.55, 0.45, 0.55, 0.45, 0.55, 0.45, 0.45, 0.45, 0.45, 0.45, 0.55, 0.45, 0.45, 0.45, 0.45, 0.45, 0.45),
        anderson_projected_residual_ratio_history=(0.5886890050532719, 0.6210220229814513, 0.5307077781292716, 0.5956449706441228, 0.49555279405993763, 0.588908182917592, 0.5797992794447102, 0.5771784693056488, 0.5717188618675011, 0.5652552974094324, 0.4685145291291921, 0.5605491402187464, 0.5587245983766594, 0.5575518304479421, 0.5552110116604231, 0.5549699845647923, 0.554014235960751),
        eigensolver_wall_time_seconds=None,
        static_local_prepare_wall_time_seconds=None,
        hartree_solve_wall_time_seconds=None,
        energy_evaluation_wall_time_seconds=None,
    ...
    supplemental_anderson_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=40,
        final_total_energy_ha=-0.1633837480357797,
        final_lowest_eigenvalue_ha=-0.39318826554298847,
        final_density_residual=0.3038956471022369,
        final_energy_change_ha=0.011151391719607995,
        total_wall_time_seconds=249.24010778700006,
        average_iteration_wall_time_seconds=6.231002694675001,
        behavior_verdict="plateau_or_stall",
        detected_two_cycle=False,
        even_odd_energy_gap_ha=None,
        even_odd_residual_gap=None,
        ...
        tail_energy_change_history_ha=(
            -0.013355944024487595,
            0.0003355154920526906,
            0.014019764048928626,
            -0.012153743931974095,
            0.011151391719607995,
        ),
        tail_residual_ratios=(
            1.0001373915747056,
            0.9953660215762192,
        ...
        average_tail_residual_ratio=1.000196737116552,
        tail_residual_ratio_std=0.00349885560182964,
        entered_plateau=True,
        diis_used_iterations=(),
        diis_fallback_iterations=(),
        anderson_used_iterations=(
        ...
        anderson_effective_damping_history=(
            0.55, 0.45, 0.55, 0.45, 0.55, 0.45, 0.45, 0.45, 0.45, 0.45, 0.55, 0.45,
            0.45, 0.45, 0.45, 0.55, 0.45, 0.45, 0.55, 0.45, 0.45, 0.45, 0.45, 0.55,
            0.45, 0.45, 0.55, 0.45, 0.45, 0.45, 0.45, 0.45, 0.45, 0.45, 0.45, 0.45, 0.45,
        ),
        anderson_projected_residual_ratio_history=(
            0.5886890050532719, 0.6210220229814513, 0.5307077781292716, 0.5956449706441228,
            0.49555279405993763, 0.588908182917592, 0.5797992794447102, 0.5771784693056488,
            0.5717188618675011, 0.5652552974094324, 0.4685145291291921, 0.5605491402187464,
            0.5587245983766594, 0.5575518304479421, 0.5552110116604231, 0.5549699845647923,
            0.554014235960751, 0.5527303887172344, 0.5513689435235737, 0.550744151238181,
            0.5504078736829606, 0.5503557662710869, 0.5503477387918987, 0.5504595653708316,
            0.5503377173152157, 0.5503478318328214, 0.5504316679194331, 0.5503822646808218,
            0.5504255509512858, 0.5503190996279545, 0.5503594186063925, 0.5503994142810421,
            0.5510994638558868, 0.5503923013720519, 0.5501463102471761, 0.5502294668545213,
            0.5501380964422784, 0.5501113890666742, 0.5501817350409859, 0.5500714391678505,
        ),
        eigensolver_wall_time_seconds=None,
        static_local_prepare_wall_time_seconds=None,
        hartree_solve_wall_time_seconds=None,
    ...
    diagnosis=(
        "The more productionish Anderson route improves the 20-step singlet residual only modestly, "
        "from about 0.3074 on the current Anderson baseline to about 0.3006, but it still does not "
        "change the pass/fail conclusion relative to the frozen 20-step acceptance window and it does "
        "not even beat the current linear-0p10 reference on residual in this run. The 40-step "
        "supplemental run then settles into a clear plateau with an average tail residual ratio of "
        "about 1.00020 and very small ratio scatter instead of maintaining strong contraction. That now "
        "supports the interpretation that the remaining obstacle is more the hardness of the singlet "
        "fixed-point map itself than a small remaining Anderson implementation gap."
    ),
    note=(
        "H2 singlet productionish-Anderson baseline on the frozen JAX A-grid local-only mainline. "
        "The 20-step acceptance view compares linear-0p10, a minimal DIIS prototype, the frozen "
        "Anderson baseline, and a more productionish Anderson that stays inside the same algorithm "
        "family while adding adaptive damping, history filtering, residual-based acceptance, and "
        "residual-growth restart. A separate 40-step supplemental run is recorded only to distinguish "
        "'not enough iterations' from a genuine tail plateau."
    ),
)
