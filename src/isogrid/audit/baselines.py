...
class H2JaxSingletMainlineRegressionBaseline:
    ...
    anderson_extended_route: H2JaxSingletMainlineRouteBaseline
...
H2_JAX_SINGLET_MAINLINE_BASELINE = H2JaxSingletMainlineRegressionBaseline(
    ...
    baseline_linear_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-0.16223500951173397,
        final_lowest_eigenvalue_ha=-0.3975136135375913,
        final_density_residual=0.3097420102260329,
        final_energy_change_ha=0.009754443957800452,
        total_wall_time_seconds=93.51938543299997,
        average_iteration_wall_time_seconds=4.675969271649999,
        ...
        tail_energy_change_history_ha=(
            0.010883553694250536,
            -0.02672825215081487,
            0.029694109055086848,
            -0.0075017602058091715,
            0.009754443957800452,
        ),
        ...
        average_tail_residual_ratio=1.0004889535435852,
        tail_residual_ratio_std=0.019989870273125588,
    ...
    diis_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-0.15347921496603767,
        final_lowest_eigenvalue_ha=-0.42886607020684736,
        final_density_residual=0.32076575599555707,
        final_energy_change_ha=0.010928401832782875,
        total_wall_time_seconds=102.63075206299999,
        average_iteration_wall_time_seconds=5.131537603149999,
        ...
        tail_energy_change_history_ha=(
            0.06046714467592973,
            -0.002098593909334756,
            -0.04006346574711206,
            0.014221880903571349,
            0.010928401832782875,
        ),
        tail_residual_ratios=(
            0.9964187782268811,
            0.9113631137715531,
        ...
        average_tail_residual_ratio=1.0019930579035115,
        tail_residual_ratio_std=0.05736329888053294,
    ...
    anderson_baseline_route=H2JaxSingletMainlineRouteBaseline(
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-0.15780363634112837,
        final_lowest_eigenvalue_ha=-0.42308982759239,
        final_density_residual=0.3142982456888624,
        final_energy_change_ha=0.018992869152194225,
        total_wall_time_seconds=107.16250262999995,
        average_iteration_wall_time_seconds=5.358125131499998,
        behavior_verdict="slow_monotone_or_damped",
        detected_two_cycle=False,
        even_odd_energy_gap_ha=None,
        even_odd_residual_gap=None,
        ...
        tail_energy_change_history_ha=(
            0.01506995118118859,
            -0.0066802357090914866,
            0.013948112654411204,
            -0.01864932258844454,
            0.018992869152194225,
        ),
        tail_residual_ratios=(
            0.9577760311950025,
            1.05874642582481,
        ...
        average_tail_residual_ratio=1.0051108931124173,
        tail_residual_ratio_std=0.06045716575098385,
        entered_plateau=False,
        diis_used_iterations=(),
        diis_fallback_iterations=(),
    ...
    anderson_extended_route=H2JaxSingletMainlineRouteBaseline(
        path_label="jax-singlet-mainline-anderson-extended",
        spin_state_label="singlet",
        path_type="monitor_a_grid_plus_patch",
        kinetic_version="trial_fix",
        max_iterations=20,
        ...
        converged=False,
        iteration_count=20,
        final_total_energy_ha=-0.17135172558235434,
        final_lowest_eigenvalue_ha=-0.3974121964391408,
        final_density_residual=0.30686411838176697,
        final_energy_change_ha=-0.006936280240238624,
        total_wall_time_seconds=100.65007858500007,
        average_iteration_wall_time_seconds=5.032503929250003,
        behavior_verdict="plateau_or_stall",
        detected_two_cycle=False,
        even_odd_energy_gap_ha=None,
        even_odd_residual_gap=None,
        ...
        tail_energy_change_history_ha=(
            -0.03129691057718342,
            0.025351793521280808,
            -0.022582547119950336,
            0.016377125843736406,
            -0.006936280240238624,
        ),
        tail_residual_ratios=(
            1.0314250841022432,
            0.9763287512524135,
        ...
        average_tail_residual_ratio=1.0076457429247512,
        tail_residual_ratio_std=0.020184522922538417,
        entered_plateau=True,
        diis_used_iterations=(),
        diis_fallback_iterations=(),
        anderson_used_iterations=(4, 5, 7, 9, 10, 11, 12, 13, 15, 16, 17, 18, 19, 20),
        anderson_fallback_iterations=(),
        anderson_reset_iterations=(2, 3, 6, 8, 14),
        eigensolver_wall_time_seconds=None,
        static_local_prepare_wall_time_seconds=None,
        hartree_solve_wall_time_seconds=None,
        energy_evaluation_wall_time_seconds=None,
    ...
    supplemental_anderson_route=H2JaxSingletMainlineRouteBaseline(
        path_label="jax-singlet-mainline-anderson-extended-long40",
        spin_state_label="singlet",
        path_type="monitor_a_grid_plus_patch",
        kinetic_version="trial_fix",
        max_iterations=40,
        ...
        converged=False,
        iteration_count=40,
        final_total_energy_ha=-0.16317688335004077,
        final_lowest_eigenvalue_ha=-0.39290215251639965,
        final_density_residual=0.3031204962141922,
        final_energy_change_ha=0.011806342958021299,
        total_wall_time_seconds=193.06724995000002,
        average_iteration_wall_time_seconds=4.826681248750001,
        behavior_verdict="plateau_or_stall",
        detected_two_cycle=False,
        even_odd_energy_gap_ha=None,
        even_odd_residual_gap=None,
        ...
        tail_energy_change_history_ha=(
            0.013435637651449728,
            -0.013174902996505589,
            0.013174878170420734,
            -0.012538675295239332,
            0.011806342958021299,
        ),
        tail_residual_ratios=(
            0.9972215838289059,
            1.0024133189800786,
        ...
        average_tail_residual_ratio=0.9995689875915008,
        tail_residual_ratio_std=0.0018903544697439197,
        entered_plateau=True,
        diis_used_iterations=(),
        diis_fallback_iterations=(),
        anderson_used_iterations=(
        ...
        anderson_fallback_iterations=(),
        anderson_reset_iterations=(2, 3, 6, 8, 12, 16, 23, 24),
        eigensolver_wall_time_seconds=None,
        static_local_prepare_wall_time_seconds=None,
        hartree_solve_wall_time_seconds=None,
        energy_evaluation_wall_time_seconds=None,
    ...
    diagnosis=(
        "The slightly more mature Anderson route improves the 20-step singlet residual only modestly, "
        "from about 0.3143 on the current Anderson baseline to about 0.3069, and it does not change "
        "the pass/fail conclusion relative to the frozen 20-step acceptance window. The 40-step "
        "supplemental run then settles into a clear plateau with an average tail residual ratio of "
        "about 0.99957 and very small ratio scatter instead of maintaining strong contraction. That now "
    ...
    note=(
        "H2 singlet Anderson adequacy baseline on the frozen JAX A-grid local-only mainline. "
        "The 20-step acceptance view compares linear-0p10, a minimal DIIS prototype, the frozen "
        "Anderson baseline, and a slightly more mature Anderson with step clipping and residual-growth "
        "restart. A separate 40-step supplemental run is recorded only to distinguish 'not enough "
        "iterations' from a genuine tail plateau."
    ),
)
